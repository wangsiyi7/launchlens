...
- UCWS Project Searcher Repository: [https://github.com/wangsiyi7/ucws-project-aggregator](https://github.com/wangsiyi7/ucws-project-aggregator)
- UCWS Project Searcher Demo: [https://wangsiyi7.github.io/ucws-project-aggregator/](https://wangsiyi7.github.io/ucws-project-aggregator/)
...
- **UCWS Project Searcher Skill**: 通过同级 `ucws-project-aggregator` 项目聚合官方 UCWS 仓库、动态项目墙快照、官方资料、双语提交表单、commit 历史、证据规范和 Agent handoff 流程。它是互补检索层，不复制官方内容为己有。
...
- **UCWS Project Searcher Skill**: a sibling `ucws-project-aggregator` project aggregates the official UCWS repo, dynamic Project Wall snapshot, official resources, bilingual submission forms, commit history, evidence norms, and Agent handoff workflow. It is a complementary search layer, not a copy of official content.
