...
| Git state | Needs input | Working tree has changes:<br>M CHANGELOG.md<br> M PROJECT_WALL_SUBMISSION.en.md<br> M PROJECT_WALL_SUBMISSION.md<br> M PROJECT_WALL_SUBMISSION.zh-CN.md<br> M project-payload.json<br> M tools/build-project-payload.mjs<br> M tools/final-readiness-report.mjs |
...
| Local demo | Needs input | Local server not reachable: fetch failed |
