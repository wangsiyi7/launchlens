...
- **UCWS Project Searcher**: 通过同级 `ucws-project-aggregator` 项目聚合官方 UCWS 仓库、动态项目墙快照、官方资料、commit 历史、证据规范和 Skill 化流程，并在 Demo 中互相跳转。
...
- **UCWS Project Searcher**: a sibling `ucws-project-aggregator` project aggregates the official UCWS repo, dynamic Project Wall snapshot, official resources, commit history, evidence norms, and Skill workflow, with cross-links from both demos.
