...
Latest re-check on June 5, 2026 (Asia/Shanghai): event metadata is still public, project submission and editing are still enabled, current participants are 545, and the anonymous Project API still returns HTTP 401.
...
- Format: hybrid
- Location: Singapore
- Participants: 545 current participants reported by the API on June 5, 2026
